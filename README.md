...
- Popup **Start/Pause** và panel trạng thái dưới khu vực Sponsored/Được tài trợ trên trang Following (không che Messenger).
...
- Ưu tiên xử lý từ cuối danh sách Following lên để tránh các thẻ đã unfollow nhưng còn kẹt ở đầu trang.
...
- A **Start/Pause** popup and an in-page status panel below the Sponsored section on the Following page only (never over Messenger).
...
- Starts each unfollow batch at the bottom of Following to avoid stale cards lingering at the top.
